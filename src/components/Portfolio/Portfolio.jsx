          ...
          <div className="col">
            <div className="card" style={{backgroundColor:(darkMode)?"#303132":"#f7f7f7",color:(darkMode)?"white":"black"}} >
              ...
              <div className="card-body">
                ...
                <a target={"_blank"} rel="noreferrer"  href="https://github.com/harsh6603/Temple-website" className="btn btn-primary">
          ...
          <div className="col" >
            <div className="card" style={{backgroundColor:(darkMode)?"#303132":"#f7f7f7",color:(darkMode)?"white":"black"}} >
              ...
              <div className="card-body">
                ...
                <a target={"_blank"} rel="noreferrer"  href="https://github.com/harsh6603/News-react-app" className="btn btn-primary">
                  <i className="fa-brands fa-github"></i>
                  <small>GitHub</small>
                </a>
              </div>
            ...
            <div className="card" style={{backgroundColor:(darkMode)?"#303132":"#f7f7f7",color:(darkMode)?"white":"black"}} >
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between">
                  <a target={"_blank"} rel="noreferrer"  href="https://github.com/harsh6603/Notescloud" className="btn btn-primary">
                    <i className="fa-brands fa-github"></i>
                    <small>GitHub</small>
                  </a>
                  <a target={"_blank"} rel="noreferrer"  href="https://notecloud-notes-app.herokuapp.com/" className="btn btn-primary">
